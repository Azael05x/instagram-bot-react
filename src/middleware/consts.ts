export const ACCOUNT_LINK = "middleware/account/ACCOUNT_LINK";
export const ACCOUNT_UNLINK = "middleware/account/ACCOUNT_UNLINK";
export const ACCOUNT_SET_STATUS = "middleware/account/ACCOUNT_SET_STATUS";
